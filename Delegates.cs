    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Helper.PrintLine("2.Add Employee ");
                ...
                switch (chooseNum)
                {
                    ...
                    inputage:
                        ...
                        Student student1 = new Student("Aysun", 92);
                        student1.Age = a;
                        student1.Surname = "Huseynli";
                    ...
                    inputempage:
                        ...
                        bool isintempage = int.TryParse(empage, out int empl);
                        if (!isintempage && empl > 0)
                        {
                            Helper.PrintLine("please include correct age", ConsoleColor.Red);
                            goto inputage;
                        }
